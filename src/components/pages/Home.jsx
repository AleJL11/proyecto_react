...
const Homestay_texto =
  "Homestay families easily set up their availability and confirm their bookings in our intuitive app.";

const Save_titulo = "Save time and money";
const Save_texto =
  "Get a real time availability of your homestay families without making a single phone call. Once the booking is confirmed everyone gets notified automatically.";

const Service_titulo = "Accommodation Provider";
const Service_texto =
  "Find the perfect match, availability and book a room in just a few clicks.";

const Service_titulo_2 = "Homestay";
const Service_texto_2 =
  "One simple and intuitive app to update availability, confirm bookings and communicate with the school.";

const Service_titulo_3 = "Student";
const Service_texto_3 =
...
const Download_texto =
  "We are working to give you a better experience from your mobile device";

const Accommodationhome_titulo = "Work With Us";
const Accommodationhome_texto =
  ...
  return (
    <>
      ...
      <div className="container__banner">
        ...
        <button className="button__banner">{Button}</button>
      </div>
      ...
      <div className="container__accommodationhome">
        <div className="img_accommodationhome">
          <img src={Accommodationhome} alt="Imagen Accommodationhome" />
        </div>
        <div className="container__texto--accommodationhome">
          <h1>{Accommodationhome_titulo}</h1>
          <p>{Accommodationhome_texto}</p>
        </div>
        <a className="button__accommodationhome" href="https://calendly.com/homebor/demo?month=2021-08"> Book a Free Demo</a>
      </div>
    </>
  );
};
